...
Afin de la remercier et de mettre en pratique vos **compétences récemment acquise en Python**, vous décidez de créer une **horloge numérique fonctionnelle**.

## Objectif du projet

Ce projet a pour but de :
- Afficher l'heure au format HH:MM:SS
- Mettre à jour l'heure automatiquemnt toutes les secondes
...
- Mettre en oeuvre une éxécution concurrente simple avec threading
...
L'utlisateur peut arrêter le programme à tout moment pendant l'exécution de ce-dernier.
**Commande :**
CTRL + C ou stop
